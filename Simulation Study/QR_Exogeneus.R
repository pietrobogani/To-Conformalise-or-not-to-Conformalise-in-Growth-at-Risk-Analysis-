...
run_simulation <- function(n,ratio_p_n){
  ...
  CQuantAR3_OOS <- qCQR_opposite(x0,y0,x1,y1,x_test,QQ) 
...
# This last part is to produce the plot of the 5 calibration curves at the same time (Figure 3 of the paper).
# It requires to indipendentlyrun the code 4 times with the 4 values of p/n, save them step by step 
# into df3,df4,... and then finally plot.
